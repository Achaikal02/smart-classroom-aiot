# mainYOLO.py
# Versi multi-person: YOLO untuk deteksi bounding box, MediaPipe per crop
...
while True:
    ...
    for r in results:
        for box in r.boxes:
            ...
            # pose per orang pakai context manager (instance baru tiap crop)
            with mp_pose.Pose(
    ...
    cv2.imshow("CV Module - YOLO", frame)
